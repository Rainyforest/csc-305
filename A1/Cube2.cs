...
//new Vector3(-4, -2.8f, 10),new Vector3(-4, 2.8f, 10),new Vector3(0, -2.8f, 9)
        for(int i = 0;i < pixel_width;++i){
            for(int j = 0; j < pixel_height;++j){
                ...
                //
                // 0   2   4
                Color Tri_1 = IntersectTriangle(RayOrigin,Direction,vertices[0],vertices[1],vertices[2]); // (0,0) (0,1) (1,0)
                Color Tri_2 = IntersectTriangle(RayOrigin,Direction,vertices[2],vertices[1],vertices[3]); // (1,0) (0,1) (1,1)
                Color Tri_3 = IntersectTriangle(RayOrigin,Direction,vertices[2],vertices[3],vertices[5]); // (1,0) (1,1) (0,1)
                Color Tri_4 = IntersectTriangle(RayOrigin,Direction,vertices[2],vertices[5],vertices[4]); // (1,0) (0,1) (0,0)
                Vector2 TextureCoordinate = new Vector2(0,0);
                float pattern_width = pattern.width;
                float pattern_height = pattern.height;

                if(Tri_1!=BackgroundColor||Tri_2!=BackgroundColor||Tri_3!=BackgroundColor||Tri_4!=BackgroundColor){
                    if(Tri_1!=BackgroundColor){
                        TextureCoordinate = Tri_1.r*new Vector2(0,0) + Tri_1.g*new Vector2(0,1) + Tri_1.b*new Vector2(1,0);
                    } else if(Tri_2!=BackgroundColor){
                        TextureCoordinate = Tri_2.r*new Vector2(1,0) + Tri_2.g*new Vector2(0,1) + Tri_2.b*new Vector2(1,1);
                    } else if(Tri_3!=BackgroundColor){
                        TextureCoordinate = Tri_3.r*new Vector2(1,0) + Tri_3.g*new Vector2(1,1) + Tri_3.b*new Vector2(0,1);
                    } else if(Tri_4!=BackgroundColor){
                        TextureCoordinate = Tri_4.r*new Vector2(1,0) + Tri_4.g*new Vector2(0,1) + Tri_4.b*new Vector2(0,0);
                    } else{}
                    pixelColor = pattern.GetPixel((int)(TextureCoordinate.x*pattern_width),(int)(TextureCoordinate.y*pattern_height));
                }
